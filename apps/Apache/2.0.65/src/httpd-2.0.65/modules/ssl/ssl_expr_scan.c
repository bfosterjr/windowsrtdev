...
#define yylineno ssl_expr_yylineno
#define yyout ssl_expr_yyout
#define yyrestart ssl_expr_yyrestart
#define yytext ssl_expr_yytext
#define yywrap ssl_expr_yywrap
#define yyalloc ssl_expr_yyalloc
#define yyrealloc ssl_expr_yyrealloc
#define yyfree ssl_expr_yyfree
...
#define YY_NEW_FILE ssl_expr_yyrestart(ssl_expr_yyin  )
...
extern int ssl_expr_yyleng;

extern FILE *ssl_expr_yyin, *ssl_expr_yyout;
...
#define yyless(n) \
	do \
		{ \
		/* Undo effects of setting up ssl_expr_yytext. */ \
        int yyless_macro_arg = (n); \
        YY_LESS_LINENO(yyless_macro_arg);\
		*yy_cp = (yy_hold_char); \
		YY_RESTORE_YY_MORE_OFFSET \
		(yy_c_buf_p) = yy_cp = yy_bp + yyless_macro_arg - YY_MORE_ADJ; \
		YY_DO_BEFORE_ACTION; /* set up ssl_expr_yytext again */ \
		} \
	while ( 0 )
...
#define YY_BUFFER_NORMAL 1
	 ...
	 * just pointing ssl_expr_yyin at a new input file.
	 */
...
/* yy_hold_char holds the character lost when ssl_expr_yytext is formed. */
...
/* Flag which is used to allow ssl_expr_yywrap()'s to do buffer switches
 * instead of setting up a fresh ssl_expr_yyin.  A bit of a hack ...
 */
static int yy_did_buffer_switch_on_eof;

void ssl_expr_yyrestart (FILE *input_file  );
void ssl_expr_yy_switch_to_buffer (YY_BUFFER_STATE new_buffer  );
YY_BUFFER_STATE ssl_expr_yy_create_buffer (FILE *file,int size  );
void ssl_expr_yy_delete_buffer (YY_BUFFER_STATE b  );
void ssl_expr_yy_flush_buffer (YY_BUFFER_STATE b  );
void ssl_expr_yypush_buffer_state (YY_BUFFER_STATE new_buffer  );
void ssl_expr_yypop_buffer_state (void );

static void ssl_expr_yyensure_buffer_stack (void );
static void ssl_expr_yy_load_buffer_state (void );
static void ssl_expr_yy_init_buffer (YY_BUFFER_STATE b,FILE *file  );

#define YY_FLUSH_BUFFER ssl_expr_yy_flush_buffer(YY_CURRENT_BUFFER )

YY_BUFFER_STATE ssl_expr_yy_scan_buffer (char *base,yy_size_t size  );
YY_BUFFER_STATE ssl_expr_yy_scan_string (yyconst char *yy_str  );
YY_BUFFER_STATE ssl_expr_yy_scan_bytes (yyconst char *bytes,int len  );

void *ssl_expr_yyalloc (yy_size_t  );
void *ssl_expr_yyrealloc (void *,yy_size_t  );
void ssl_expr_yyfree (void *  );
...
#define yy_set_interactive(is_interactive) \
	...
	if ( ! YY_CURRENT_BUFFER ){ \
        ssl_expr_yyensure_buffer_stack (); \
		YY_CURRENT_BUFFER_LVALUE =    \
            ssl_expr_yy_create_buffer(ssl_expr_yyin,YY_BUF_SIZE ); \
	} \
...
FILE *ssl_expr_yyin = (FILE *) 0, *ssl_expr_yyout = (FILE *) 0;

typedef int yy_state_type;

extern int ssl_expr_yylineno;

int ssl_expr_yylineno = 1;

extern char *ssl_expr_yytext;
#define yytext_ptr ssl_expr_yytext
 ...
 * corresponding action - sets up ssl_expr_yytext.
 */
#define YY_DO_BEFORE_ACTION \
	(yytext_ptr) = yy_bp; \
	ssl_expr_yyleng = (size_t) (yy_cp - yy_bp); \
	(yy_hold_char) = *yy_cp; \
	*yy_cp = '\0'; \
	(yy_c_buf_p) = yy_cp;
...
extern int ssl_expr_yy_flex_debug;
int ssl_expr_yy_flex_debug = 0;
...
int ssl_expr_yylex_destroy (void );

int ssl_expr_yyget_debug (void );

void ssl_expr_yyset_debug (int debug_flag  );

YY_EXTRA_TYPE ssl_expr_yyget_extra (void );

void ssl_expr_yyset_extra (YY_EXTRA_TYPE user_defined  );

FILE *ssl_expr_yyget_in (void );

void ssl_expr_yyset_in  (FILE * in_str  );

FILE *ssl_expr_yyget_out (void );

void ssl_expr_yyset_out  (FILE * out_str  );

int ssl_expr_yyget_leng (void );

char *ssl_expr_yyget_text (void );

int ssl_expr_yyget_lineno (void );

void ssl_expr_yyset_lineno (int line_number  );
...
#ifdef __cplusplus
extern "C" int ssl_expr_yywrap (void );
#else
extern int ssl_expr_yywrap (void );
#endif
#endif
 ...
 * we now use fwrite().
 */
#define ECHO fwrite( ssl_expr_yytext, ssl_expr_yyleng, 1, ssl_expr_yyout )
#endif
...
#define YY_INPUT(buf,result,max_size) \
	if ( YY_CURRENT_BUFFER_LVALUE->yy_is_interactive ) \
		...
		int n; \
		for ( n = 0; n < max_size && \
			     (c = getc( ssl_expr_yyin )) != EOF && c != '\n'; ++n ) \
			buf[n] = (char) c; \
		if ( c == '\n' ) \
			buf[n++] = (char) c; \
		if ( c == EOF && ferror( ssl_expr_yyin ) ) \
		...
		{ \
		errno=0; \
		while ( (result = fread(buf, 1, max_size, ssl_expr_yyin))==0 && ferror(ssl_expr_yyin)) \
			{ \
			if( errno != EINTR) \
				{ \
				YY_FATAL_ERROR( "input in flex scanner failed" ); \
...
#define YY_DECL int ssl_expr_yylex (void)
#endif /* !YY_DECL */

/* Code executed at the beginning of each rule, after ssl_expr_yytext and ssl_expr_yyleng
 * have been set up.
 */
...
#line 89 "ssl_expr_scan.l"
{
    ...
    (void)sscanf(ssl_expr_yytext+1, "%o", &result);
    if (result > 0xff)
...
{
    if (ssl_expr_yytext[0] == cRegexDel) {
        *cpRegex = NUL;
        BEGIN(regex_flags);
    }
    else {
        *cpRegex++ = ssl_expr_yytext[0];
    }
}
	YY_BREAK
case 17:
...
{
    yylval.cpVal = apr_pstrdup(ssl_expr_info.pool, ssl_expr_yytext);
    return T_DIGIT;
}
	YY_BREAK
/*
	...
	case YY_END_OF_BUFFER:
		...
		*yy_cp = (yy_hold_char);
		...
		if ( YY_CURRENT_BUFFER_LVALUE->yy_buffer_status == YY_BUFFER_NEW )
			 ...
			 * just pointed ssl_expr_yyin at a new source and called
			...
			YY_CURRENT_BUFFER_LVALUE->yy_input_file = ssl_expr_yyin;
		...
		if ( (yy_c_buf_p) <= &YY_CURRENT_BUFFER_LVALUE->yy_ch_buf[(yy_n_chars)] )
			...
			case EOB_ACT_END_OF_FILE:
				...
				if ( ssl_expr_yywrap( ) )
					 ...
					 * ssl_expr_yytext, we can now set up
...
static int yy_get_next_buffer (void)
{
		...
		while ( num_to_read <= 0 )
			...
			if ( b->yy_is_our_buffer )
				...
				b->yy_ch_buf = (char *)
					...
					ssl_expr_yyrealloc((void *) b->yy_ch_buf,b->yy_buf_size + 2  );
				}
			else
	...
	if ( (yy_n_chars) == 0 )
		...
		if ( number_to_move == YY_MORE_ADJ )
			...
			ssl_expr_yyrestart(ssl_expr_yyin  );
			}
	...
	if ((yy_size_t) ((yy_n_chars) + number_to_move) > YY_CURRENT_BUFFER_LVALUE->yy_buf_size) {
		...
		YY_CURRENT_BUFFER_LVALUE->yy_ch_buf = (char *) ssl_expr_yyrealloc((void *) YY_CURRENT_BUFFER_LVALUE->yy_ch_buf,new_size  );
...

{
	...
	*(yy_c_buf_p) = '\0';	/* preserve ssl_expr_yytext */
    ...
    void ssl_expr_yyrestart  (FILE * input_file )
{
	...
	ssl_expr_yy_init_buffer(YY_CURRENT_BUFFER,input_file );
	ssl_expr_yy_load_buffer_state( );
}
...
static void ssl_expr_yy_load_buffer_state  (void)
{
	...
	ssl_expr_yyin = YY_CURRENT_BUFFER_LVALUE->yy_input_file;
	(yy_hold_char) = *(yy_c_buf_p);
}
    ...
    YY_BUFFER_STATE ssl_expr_yy_create_buffer  (FILE * file, int  size )
{
	...
	b = (YY_BUFFER_STATE) ssl_expr_yyalloc(sizeof( struct yy_buffer_state )  );
	if ( ! b )
	 ...
	 */
	b->yy_ch_buf = (char *) ssl_expr_yyalloc(b->yy_buf_size + 2  );
	if ( ! b->yy_ch_buf )
		YY_FATAL_ERROR( "out of dynamic memory in ssl_expr_yy_create_buffer()" );

	b->yy_is_our_buffer = 1;

	ssl_expr_yy_init_buffer(b,file );
    ...
    void ssl_expr_yy_delete_buffer (YY_BUFFER_STATE  b )
{
	...
	if ( b->yy_is_our_buffer )
		ssl_expr_yyfree((void *) b->yy_ch_buf  );

	ssl_expr_yyfree((void *) b  );
}
...
void ssl_expr_yypop_buffer_state (void)
{
	...
	ssl_expr_yy_delete_buffer(YY_CURRENT_BUFFER );
...
static void ssl_expr_yyensure_buffer_stack (void)
{
	...
	if (!(yy_buffer_stack)) {
         ...
         */
		num_to_alloc = 1;
		(yy_buffer_stack) = (struct yy_buffer_state**)ssl_expr_yyalloc
	...
	if ((yy_buffer_stack_top) >= ((yy_buffer_stack_max)) - 1){
		...
		(yy_buffer_stack) = (struct yy_buffer_state**)ssl_expr_yyrealloc
								((yy_buffer_stack),
								num_to_alloc * sizeof(struct yy_buffer_state*)
								);
		if ( ! (yy_buffer_stack) )
...
YY_BUFFER_STATE ssl_expr_yy_scan_buffer  (char * base, yy_size_t  size )
{
	...
	ssl_expr_yy_switch_to_buffer(b  );
 ...
 */
YY_BUFFER_STATE ssl_expr_yy_scan_string (yyconst char * yystr )
{
    
	return ssl_expr_yy_scan_bytes(yystr,strlen(yystr) );
}
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE ssl_expr_yy_scan_bytes  (yyconst char * yybytes, int  _yybytes_len )
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
	...
	b = ssl_expr_yy_scan_buffer(buf,n );
	if ( ! b )
...
#define yyless(n) \
	do \
        ...
        int yyless_macro_arg = (n); \
        YY_LESS_LINENO(yyless_macro_arg);\
		ssl_expr_yytext[ssl_expr_yyleng] = (yy_hold_char); \
		(yy_c_buf_p) = ssl_expr_yytext + yyless_macro_arg; \
		(yy_hold_char) = *(yy_c_buf_p); \
		*(yy_c_buf_p) = '\0'; \
		ssl_expr_yyleng = yyless_macro_arg; \
		} \
	while ( 0 )
...
void ssl_expr_yyset_in (FILE *  in_str )
{
        ssl_expr_yyin = in_str ;
}

void ssl_expr_yyset_out (FILE *  out_str )
{
        ssl_expr_yyout = out_str ;
}

int ssl_expr_yyget_debug  (void)
{
        return ssl_expr_yy_flex_debug;
}

void ssl_expr_yyset_debug (int  bdebug )
{
        ssl_expr_yy_flex_debug = bdebug ;
}
...
/* Defined in main.c */
    ...
    ssl_expr_yyout = stdout;
#else
    ssl_expr_yyin = (FILE *) 0;
    ssl_expr_yyout = (FILE *) 0;
#endif
...
int ssl_expr_yylex_destroy  (void)
{
	...
	ssl_expr_yyfree((yy_buffer_stack) );
...
void *ssl_expr_yyalloc (yy_size_t  size )
{
	return (void *) malloc( size );
}

void *ssl_expr_yyrealloc  (void * ptr, yy_size_t  size )
{
