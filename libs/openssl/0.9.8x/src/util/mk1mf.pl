...
%ops=(
	...
	"VC-ARM",	"Microsoft Visual Studio 2012 - Windows RT",
...
if (($platform eq "VC-WIN32") || ($platform eq "VC-WIN64A")
	|| ($platform eq "VC-WIN64I") || ($platform eq "VC-NT") || ($platform eq "VC-ARM")) {
    $rules.= <<"EOF";
...
sub do_defs
	...
	# hack to add version info on MSVC
	if ($shlib && (($platform eq "VC-WIN32") || ($platfrom eq "VC-WIN64I") || ($platform eq "VC-WIN64A") || ($platform eq "VC-NT") || ($platform eq "VC-ARM") ))
		{
		if ($var eq "CRYPTOOBJ")
